# Truss ![Build Status](https://github.com/Reasno/trs/workflows/Go/badge.svg?branch=master)
...
1. Install Truss with
	...
	```
	go get -u -d github.com/Reasno/trs
	cd $GOPATH/src/github.com/Reasno/trs
	make dependencies
	make
	```
